...
#include "neo_msgs2/msg/detail/safety_mode__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const neo_msgs2::msg::SafetyMode & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  neo_msgs2::msg::SafetyMode & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = neo_msgs2::msg::SafetyMode;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const neo_msgs2::msg::SafetyMode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<neo_msgs2::msg::SafetyMode *>(
    untyped_ros_message);
...
{
  return &neo_msgs2::msg::typesupport_fastrtps_cpp::_SafetyMode__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, neo_msgs2, msg, SafetyMode)() {
  return &neo_msgs2::msg::typesupport_fastrtps_cpp::_SafetyMode__handle;
}
