...
class Init_RelayBoardV3_led_state
{
public:
  explicit Init_RelayBoardV3_led_state(::neo_msgs2::msg::RelayBoardV3 & msg)
  : msg_(msg)
  {}
  ::neo_msgs2::msg::RelayBoardV3 led_state(::neo_msgs2::msg::RelayBoardV3::_led_state_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_RelayBoardV3_led_state release_structure_state(::neo_msgs2::msg::RelayBoardV3::_release_structure_state_type arg)
  {
    msg_.release_structure_state = std::move(arg);
    return Init_RelayBoardV3_led_state(msg_);
  }
