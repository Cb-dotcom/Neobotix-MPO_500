...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RelayBoardV3_message_member_array[10] = {
  {
    "time",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(neo_msgs2::msg::RelayBoardV3, led_state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
