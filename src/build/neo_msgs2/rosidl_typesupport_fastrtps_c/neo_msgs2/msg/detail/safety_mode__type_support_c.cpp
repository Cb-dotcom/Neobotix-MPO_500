...
#include "neo_msgs2/msg/detail/safety_mode__rosidl_typesupport_fastrtps_c.h"
...
using _SafetyMode__ros_msg_type = neo_msgs2__msg__SafetyMode;
...
static uint32_t _SafetyMode__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_neo_msgs2__msg__SafetyMode(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = neo_msgs2__msg__SafetyMode;
    is_plain =
      (
...
static size_t _SafetyMode__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_neo_msgs2__msg__SafetyMode(
