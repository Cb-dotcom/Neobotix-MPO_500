...
{
  new (message_memory) neo_msgs2::msg::SafetyMode(_init);
}

void SafetyMode_fini_function(void * message_memory)
{
  auto typed_message = static_cast<neo_msgs2::msg::SafetyMode *>(message_memory);
  typed_message->~SafetyMode();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember SafetyMode_message_member_array[2] = {
  {
    "header",  // name
    ...
    offsetof(neo_msgs2::msg::SafetyMode, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(neo_msgs2::msg::SafetyMode, mode),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SafetyMode_message_members = {
  ...
  2,  // number of fields
  sizeof(neo_msgs2::msg::SafetyMode),
...
get_message_type_support_handle<neo_msgs2::msg::SafetyMode>()
{
  return &::neo_msgs2::msg::rosidl_typesupport_introspection_cpp::SafetyMode_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, neo_msgs2, msg, SafetyMode)() {
  return &::neo_msgs2::msg::rosidl_typesupport_introspection_cpp::SafetyMode_message_type_support_handle;
}
